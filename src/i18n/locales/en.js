export default {
  ...
  help: {
    ...
    mathFunctionsTitle: '🧮 C Math Library Functions (<math.h>)',
    mathFunctionsDesc: 'You can directly call standard C mathematical library functions inside Assignment, Decision, and Loop blocks:',
    mathColFunc: 'Function',
    mathColDesc: 'Description & C Equivalent',
    mathColExample: 'Usage Example',
    mathColResult: 'Result',
    mathSqrt: 'Square root (x >= 0)',
    mathPow: 'Power (x raised to y)',
    mathAbs: 'Absolute value',
    mathFloor: 'Floor (Round down to integer)',
    mathCeil: 'Ceil (Round up to integer)',
    mathRound: 'Round to nearest integer',
    mathTrig: 'Trigonometric functions (in radians)',
    mathLogExp: 'Natural log (ln), base-10 log, and e^x',
    mathQuadraticTitle: '💡 Example: Quadratic Equation Roots (ax² + bx + c = 0)',
    mathQuadraticDesc: 'Discriminant: <code>delta = pow(b, 2) - 4 * a * c</code><br>Root 1: <code>x1 = (-b + sqrt(delta)) / (2 * a)</code><br>Root 2: <code>x2 = (-b - sqrt(delta)) / (2 * a)</code>',
